...
"""
[[MIMB19N]]
    Type = EmonHubSamsungASHPMinimalModbusInterfacer
    [[[init_settings]]]
        device = /dev/ttyUSB0
        baud = 9600
    [[[runtimesettings]]]
...
class EmonHubSamsungASHPMinimalModbusInterfacer(EmonHubInterfacer):
    ...
    def __init__(self, name, device="/dev/modbus", baud=9600):
        ...
        """
        # Initialization
        super(EmonHubSamsungASHPMinimalModbusInterfacer, self).__init__(name)
